...
/**
 * Default implementation of {@link UniqueTicketIdGenerator}. Implementation utilizes a DefaultLongNumericGeneraor and a
 * DefaultRandomStringGenerator to construct the ticket id.
 * <p>
...
public final class DefaultUniqueTicketIdGenerator implements
	...
	/**
	 * Optional suffix to ensure uniqueness across JVMs by specifying unique values.
	 */
	private final String suffix;

	/**
	 * Creates an instance of DefaultUniqueTicketIdGenerator with default values including a
	 * {@link DefaultLongNumericGenerator} with a starting value of 1.
	 */
	 ...
	 *
	 * @param maxLength
	 *            the maximum length of the random string used to generate the id.
	 */
	 ...
	 *
	 * @param suffix
	 *            the value to append at the end of the unique id to ensure uniqueness across JVMs.
	 */
	...
	public String getNewTicketId(final String prefix) {
		...
		final StringBuilder buffer = new StringBuilder(
				prefix.length()
						...
						+ this.randomStringGenerator.getMaxLength()
						+ number.length());
