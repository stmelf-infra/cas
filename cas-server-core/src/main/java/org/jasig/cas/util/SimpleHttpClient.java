...
public final class SimpleHttpClient implements HttpClient, Serializable, DisposableBean {
	...
	/**
	 * Note that changing this executor will affect all httpClients. While not ideal, this change was made because
	 * certain ticket registries were persisting the HttpClient and thus getting serializable exceptions.
	 * 
