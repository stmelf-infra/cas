...
/**
 * Simple health check monitor that reports the overall health as the greatest reported {@link StatusCode} of an
 * arbitrary number of individual checks.
 *
...
public class HealthCheckMonitor implements Monitor<HealthStatus> {
	 ...
	 *
	 * @param monitors
	 *            Collection of monitors responsible for observing various aspects of CAS.
	 */
