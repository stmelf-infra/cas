...
public abstract class AbstractCacheMonitor extends AbstractNamedMonitor<CacheStatus> {
	 ...
	 *
	 * @param count
	 *            Threshold for number of cache evictions.
	 */
	 ...
	 *            Cache statistics.
	 *
	 * @return {@link StatusCode#WARN} if eviction count is above threshold or if percent free space is below threshold,
	 *         otherwise {@link StatusCode#OK}.
	 */
