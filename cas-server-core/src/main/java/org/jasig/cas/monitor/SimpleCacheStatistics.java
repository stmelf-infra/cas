...
public class SimpleCacheStatistics implements CacheStatistics {
	 ...
	 * @param capacity
	 *            Current cache capacity (e.g. items, bytes, etc). The units of capacity must be equal to size in order
	 *            to produce a meaningful value for {@link #getPercentFree}.
	 * @param evictions
	 *            Number of evictions reported by cache.
	 */
