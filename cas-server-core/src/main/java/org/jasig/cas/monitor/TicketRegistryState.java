 ...
 * {@link org.jasig.cas.ticket.registry.TicketRegistry} components that might be of interest to monitors.
 *
...
public interface TicketRegistryState {
	 ...
	 *
	 * @return Number of ticket-granting tickets in the registry at time of invocation or {@link Integer#MIN_VALUE} if
	 *         unknown.
	 */
	int sessionCount();
