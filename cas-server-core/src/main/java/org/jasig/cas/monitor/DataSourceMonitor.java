...
public class DataSourceMonitor extends AbstractPoolMonitor {
	...
	/**
	 * Sets the validation query used to monitor the data source. The validation query should return at least one
	 * result; otherwise results are ignored.
	 *
	 * @param query
	 *            Validation query that should be as efficient as possible.
	 */
