 ...
 * <a href="http://developer.jasig.org/projects/person-directory/1.5.0-SNAPSHOT/apidocs/">Person Directory API</a>. The
 * {@link org.jasig.cas.authentication.principal.Principal#getAttributes()} are populated by the results of the query
 * and the principal ID may optionally be set by proving an attribute whose first non-null value is used; otherwise the
 * credential ID is used for the principal ID.
 *
...
public class PersonDirectoryPrincipalResolver implements PrincipalResolver {
	 ...
	 *
	 * @param attribute
	 *            Name of attribute containing principal ID.
	 */
