...
/**
 * Produces {@link ContextualAuthenticationPolicy} instances that are satisfied iff the given {@link Authentication} was
 * created by authenticating credentials by all handlers named in
