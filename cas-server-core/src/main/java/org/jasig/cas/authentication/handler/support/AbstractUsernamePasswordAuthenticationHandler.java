...
public abstract class AbstractUsernamePasswordAuthenticationHandler extends
	 ...
	 *
	 * @return HandlerResult resolved from credential on authentication success or null if no principal could be
	 ...
	 *
	 * @param credential
	 *            the credential on which the authentication was successfully performed. Note that this credential
	 *            instance may be different from what was originally provided as transformation of the username may have
	 *            occurred, if one is in fact defined.
	 * @param principal
