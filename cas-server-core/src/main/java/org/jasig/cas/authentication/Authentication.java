...
/**
 * <p>
 * The Authentication object represents a successful authentication request. It contains the principal that the
 * authentication request was made for as well as the additional meta information such as the authenticated date and a
 * map of attributes.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Implementing classes must take care to ensure that the Map returned by getAttributes is serializable by using a
 * Serializable map such as HashMap.
 * </p>
 *
...
public interface Authentication extends Serializable {
	 ...
	 *         long-term storage (e.g. serializable and secure with respect to credential disclosure). The order of
	 *         items in the returned list SHOULD be the same as the order in which the source credentials were presented
