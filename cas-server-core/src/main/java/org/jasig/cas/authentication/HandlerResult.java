...
/**
 * Contains information about a successful authentication produced by an {@link AuthenticationHandler}. Handler results
 * are naturally immutable since they contain sensitive information that should not be modified outside the
 * {@link AuthenticationHandler} that produced it.
 *
