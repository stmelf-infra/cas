...
/**
 * Authentication raised by {@link AuthenticationManager} to signal authentication failure. Authentication failure
 * typically occurs when one or more {@link AuthenticationHandler} components fail to authenticate credentials. This
 * exception contains information about handler successes and failures that may be used by higher-level components to
...
public class AuthenticationException extends Exception {
	...
	/**
	 * Creates a new instance for the case when there are both handler successes and failures and a custom error message
	 * is required.
	 *
	 * @param handlerErrors
	 *            Map of handler names to errors.
