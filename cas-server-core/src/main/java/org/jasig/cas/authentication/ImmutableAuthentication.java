...
/**
 * Immutable authentication event whose attributes may not change after creation. This class is designed for
 * serialization and is suitable for long-term storage.
 *
...
public final class ImmutableAuthentication implements Authentication, Serializable {
	 ...
	 * @param credentials
	 *            Non-null list of credential metadata containing at least one entry.
	 * @param principal
	 *            Non-null authenticated principal.
	 * @param attributes
	 *            Nullable map of authentication metadata.
	 * @param successes
	 *            Non-null map of authentication successes containing at least one entry.
	 * @param failures
	 *            Nullable map of authentication failures.
	 */
