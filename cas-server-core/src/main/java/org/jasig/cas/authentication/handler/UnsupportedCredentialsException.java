...
/**
 * The exception thrown when a Handler does not know how to determine the validity of the credentials based on the fact
 * that it does not know what to do with the credentials presented.
 *
