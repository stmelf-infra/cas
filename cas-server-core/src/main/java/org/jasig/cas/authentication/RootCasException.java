...
/**
 * Generic CAS exception that sits at the top of the exception hierarchy. Provides unified logic around retrieval and
 * configuration of exception codes that may be mapped inside an external resource bundle for internationalization of
 * error messages.
 *
...
public abstract class RootCasException extends Exception {
	...
	/**
	 * Constructor that takes a <code>code</code> description of the error along with the exception <code>msg</code>
	 * generally for logging purposes. These codes normally have a corresponding entries in the messages file for the
	 * internationalization of error messages.
	 *
	 * @param code
	 *            the code to describe what type of exception this is.
	 */
	 ...
	 *            the code to describe what type of exception this is.
	 * @param msg
	 *            The error message associated with this exception for additional logging purposes.
	 */
	 ...
	 *            the code to describe what type of exception this is.
	 * @param throwable
	 *            the original exception we are chaining.
	 */
	...
	/**
	 * @return Returns the code. If there is a chained exception it recursively calls {@link #getCode()} of the chained
	 *         exception rather than the returning the code itself.
	 */
