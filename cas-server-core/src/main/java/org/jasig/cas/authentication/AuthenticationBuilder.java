...
public class AuthenticationBuilder {
	...
	/**
	 * Creates a new instance using the current date for the authentication date and the given principal for the
	 * authenticated principal.
	 *
	 * @param p
	 *            Authenticated principal.
	 ...
	 *
	 * @param credentials
	 *            Non-null list of credential metadata.
	 *
	 * @return This builder instance.
	 */
	 ...
	 *
	 * @param attributes
	 *            Non-null map of authentication metadata attributes.
	 *
	 * @return This builder instance.
	 */
	 ...
	 * @param value
	 *            Successful authentication handler result produced by handler of given name.
	 *
	 * @return This builder instance.
	 */
	 ...
	 *
	 * @param failures
	 *            Non-null map of handler name to authentication failures.
	 *
	 * @return This builder instance.
	 */
	 ...
	 *            Authentication handler name.
	 * @param value
	 *            Exception raised on handler failure to authenticate credential.
	 *
	 * @return This builder instance.
	 */
