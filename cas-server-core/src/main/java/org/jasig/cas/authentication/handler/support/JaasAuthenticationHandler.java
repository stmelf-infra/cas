 ...
 *
 * <p>
 * Using the JAAS Authentication Handler requires you to configure the appropriate JAAS modules. You can specify the
 * location of a jass.conf file using the following VM parameter:
 * 
 * <pre>
...
public class JaasAuthenticationHandler extends AbstractUsernamePasswordAuthenticationHandler {
	...
	/**
	 * A simple JAAS CallbackHandler which accepts a Name String and Password String in the constructor. Only
	 * NameCallbacks and PasswordCallbacks are accepted in the callback array. This code based loosely on example given
