...
/**
 * The most generic type of authentication exception that one can catch if not sure what specific implementation will be
 * thrown. Top of the tree of all other AuthenticationExceptions.
 *
...
public abstract class AuthenticationException extends RootCasException {
	...
	/**
	 * @param type
	 *            The type of the error message that caused the exception to be thrown. By default, all errors are
	 *            considered of <code>error</code>.
	 * @param code
	 *            the exception code
	 * @param msg
	 *            the error message
	 ...
	 *            the exception code
	 * @param throwable
	 *            the exception that originally caused the authentication failure
	 */
