...
/**
 * Describes a principal resolution error, which is a subcategory of authentication error. Principal resolution
 * necessarily happens after successful authentication for a given credential.
 *
