...
/**
 * Generic Bad Credential Exception. This can be thrown when the system knows the credentials are not valid
 * specificially because they are bad. Subclasses can be specific to a certain type of Credential
