...
public class UnresolvedPrincipalException extends PrincipalException {
	...
	/**
	 * Creates a new instance from an authentication event that was successful prior to principal resolution. This form
	 * should be used when a resolver exception prevented principal resolution.
	 *
	 * @param authentication
	 *            Authentication event.
	 * @param cause
	 *            Exception that prevented principal resolution.
	 */
