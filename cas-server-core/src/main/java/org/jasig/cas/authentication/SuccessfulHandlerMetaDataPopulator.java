 ...
 * authenticated credential. The attribute name is given by {@link #SUCCESSFUL_AUTHENTICATION_HANDLERS}. This component
 * provides a simple method to inject successful handlers into the CAS ticket validation response to support level of
 * assurance and MFA use cases.
 *
