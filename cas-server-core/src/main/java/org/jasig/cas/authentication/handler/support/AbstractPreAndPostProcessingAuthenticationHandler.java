...
/**
 * Abstract authentication handler that allows deployers to utilize the bundled AuthenticationHandlers while providing a
 * mechanism to perform tasks before and after authentication.
 *
