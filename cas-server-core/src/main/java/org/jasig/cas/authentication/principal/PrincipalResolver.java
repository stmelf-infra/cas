...
/**
 * Resolves a {@link Principal} from a {@link Credential} using an arbitrary strategy. Since a {@link Principal}
 * requires an identifier at a minimum, the simplest strategy to produce a principal is to simply copy
...
public interface PrincipalResolver {
	...
	/**
	 * Determines whether this instance supports principal resolution from the given credential. This method SHOULD be
	 * called prior to {@link #resolve(org.jasig.cas.authentication.Credential)}.
	 *
	 * @param credential
