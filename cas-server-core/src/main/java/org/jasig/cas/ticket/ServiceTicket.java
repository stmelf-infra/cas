...
/**
 * Interface for a Service Ticket. A service ticket is used to grant access to a specific service for a principal. A
 * Service Ticket is generally a one-time use ticket.
 *
...
public interface ServiceTicket extends Ticket {
	 ...
	 * 
	 * @param service
	 *            The incoming service to match this service ticket against.
	 * @return true, if the match is successful.
	 */
	boolean isValidFor(Service service);

	/**
	 * Method to grant a TicketGrantingTicket from this service to the authentication. Analogous to the
	 * ProxyGrantingTicket.
	 *
	 * @param id
	 *            The unique identifier for this ticket.
	 * @param authentication
	 *            The Authentication we wish to grant a ticket for.
