...
public interface TicketGrantingTicket extends Ticket {
	...
	/**
	 * Gets a list of supplemental authentications associated with this ticket. A supplemental authentication is one
	 * other than the one used to create the ticket, for example, a forced authentication that happens after the
	 * beginning of a CAS SSO session.
	 *
