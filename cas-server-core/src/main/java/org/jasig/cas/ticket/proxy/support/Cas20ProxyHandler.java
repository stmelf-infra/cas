 ...
 * <p>
 * The default behavior as defined in the CAS 2 Specification is to callback the URL provided and give it a pgtIou and a
 * pgtId.
 * </p>
 *
...
public final class Cas20ProxyHandler implements ProxyHandler {
	...
	public String handle(final Credential credential, final String proxyGrantingTicketId) {
		...
		final int bufferLength =
				serviceCredentialsAsString.length() + proxyIou.length() + proxyGrantingTicketId.length() + 15;
