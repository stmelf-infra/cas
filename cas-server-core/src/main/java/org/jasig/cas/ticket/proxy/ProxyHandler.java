...
/**
 * Abstraction for what needs to be done to handle proxies. Useful because the generic flow for all authentication is
 * similar the actions taken for proxying are different. One can swap in/out implementations but keep the flow of events
 * the same.
 *
...
public interface ProxyHandler {
	 ...
	 *            The ticketId for the ProxyGrantingTicket (in CAS 3 this is a TicketGrantingTicket)
