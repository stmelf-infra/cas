...
public final class ServiceTicketImpl extends AbstractTicket implements
	...
	/**
	 * Constructs a new ServiceTicket with a Unique Id, a TicketGrantingTicket, a Service, Expiration Policy and a flag
	 * to determine if the ticket creation was from a new Login or not.
	 *
	 * @param id
	 ...
	 */
	protected ServiceTicketImpl(
			final String id,
			final TicketGrantingTicketImpl ticket,
