 ...
 * to JGroups for having distributed registries. It is up to specific implementations to determine their clean up
 * strategy. Strategies can include a manual clean up by a RegistryCleaner or a more sophisticated strategy such as LRU.
 *
...
public interface TicketRegistry {
	 ...
	 * @param <T>
	 *            the generic ticket type to return that extends {@link Ticket}
