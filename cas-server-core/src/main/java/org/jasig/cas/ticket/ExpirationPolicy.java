...
/**
 * Strategy that determines if the ticket is expired. Implementations of the Expiration Policy define their own rules on
 * what they consider an expired Ticket to be.
 *
