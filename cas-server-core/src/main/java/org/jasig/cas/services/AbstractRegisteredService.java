...
public abstract class AbstractRegisteredService implements RegisteredService, Comparable<RegisteredService>,
	...
	/**
	 * The attribute filter instance that is responsible for determining the collection of attributes available for
	 * release based on this registered service and the filter's policy.
	 */
	@Transient
	private RegisteredServiceAttributeFilter attributeFilter = null;

	/**
	 * Name of the user attribute that this service expects as the value of the username payload in the validate
	 * responses.
	 */
	...
	/**
	 * The logout type of the service. As front channel SLO is an experimental feature, the default logout type is the
	 * back channel one.
	 */
	@Transient
	...
	/**
	 * {@inheritDoc} Compares this instance with the <code>other</code> registered service based on evaluation order,
	 * name. The name comparison is case insensitive.
	 *
