...
public interface RegisteredService extends Cloneable, Serializable {
	...
	/**
	 * Determines whether the service is allowed anonymous or privileged access to user information. Anonymous access
	 * should not return any identifying information such as user id.
	 *
	...
	/**
	 * The numeric identifier for this service. Implementations are expected to initialize the id with the value of
	 * {@link #INITIAL_IDENTIFIER_VALUE}.
	 * 
	 ...
	 * 
	 * @return Evaluation order relative to other registered services. Services with lower values will be evaluated for
	 *         a match before others.
	 */
	...
	/**
	 * Gets the set of handler names that must successfully authenticate credentials in order to access the service. An
	 * empty set indicates that there are no requirements on particular authentication handlers; any will suffice.
	 *
