...
/**
 * Manages the storage, retrieval, and matching of Services wishing to use CAS and services that have been registered
 * with CAS.
 *
...
public interface ServicesManager {
	 ...
	 *            the RegisteredService to update or add.
