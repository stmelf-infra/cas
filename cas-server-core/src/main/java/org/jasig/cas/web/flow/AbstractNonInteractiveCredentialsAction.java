...
/**
 * Abstract class to handle the retrieval and authentication of non-interactive credential such as client certificates,
 * NTLM, etc.
 *
...
public abstract class AbstractNonInteractiveCredentialsAction extends
	 ...
	 *
	 * @param context
	 *            the context for this specific request.
	 * @param credential
