...
/**
 * A builder that uses the saml standard's <code>LogoutRequest</code> template in order to build the logout request.
 * 
...
public final class SamlCompliantLogoutMessageCreator implements LogoutMessageCreator {
	...
	public String create(final LogoutRequest request) {
		final String logoutRequest = String.format(
				LOGOUT_REQUEST_TEMPLATE,
				GENERATOR.getNewTicketId("LR"),
				SamlDateUtils.getCurrentDateAndTime(),
				request.getTicketId());
