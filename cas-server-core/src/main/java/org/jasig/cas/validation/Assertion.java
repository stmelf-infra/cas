 ...
 *
 * @since 3.0
 * @see org.jasig.cas.CentralAuthenticationService#validateServiceTicket(String,
...
public interface Assertion {
	...
	/**
	 * True if the validated ticket was granted in the same transaction as that in which its grantor GrantingTicket was
	 * originally issued.
	 *
	 * @return true if validated ticket was granted simultaneous with its grantor's issuance
	 */
