...
/**
 * Validation specification for the CAS 2.0 protocol. This specification extends the
 * Cas20ProtocolValidationSpecification, checking for the presence of renew=true and if requested, succeeding only if
 * ticket validation is occurring from a new login. Additionally, this specification will not accept proxied
 * authentications.
 *
