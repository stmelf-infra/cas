...
/**
 * Base validation specification for the CAS protocol. This specification checks for the presence of renew=true and if
 * requested, succeeds only if ticket validation is occurring from a new login.
 *
...
public abstract class AbstractCasProtocolValidationSpecification implements ValidationSpecification {
	...
	/**
	 * Template method to allow for additional checks by subclassed methods without needing to call
	 * super.isSatisfiedBy(...).
	 * 
	 * @param assertion
	 *            the assertion
