...
/**
 * The ProxyController is involved with returning a Proxy Ticket (in CAS 2 terms) to the calling application. In CAS 3,
 * a Proxy Ticket is just a Service Ticket granted to a service.
 * <p>
...
public final class ProxyController extends AbstractController {
	...
	private ModelAndView generateErrorView(
			final String code,
