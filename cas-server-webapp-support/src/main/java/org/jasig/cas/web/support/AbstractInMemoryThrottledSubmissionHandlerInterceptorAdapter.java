...
/**
 * Implementation of a HandlerInterceptorAdapter that keeps track of a mapping of IP Addresses to number of failures to
 * authenticate.
 * <p>
 * Note, this class relies on an external method for decrementing the counts (i.e. a Quartz Job) and runs independent of
 * the threshold of the parent.
 *
