...
public abstract class AbstractLogoutAction extends AbstractAction {
	 ...
	 */
	protected abstract Event doInternalExecute(
			final HttpServletRequest request,
			final HttpServletResponse response,
			final RequestContext context) throws Exception;

	/**
	 * Prevent caching by adding the appropriate headers. Copied from the <code>preventCaching</code> method in the
	 * {@link WebContentGenerator} class.
	 *
	 * @param response
	 *            the HTTP response.
	 */
