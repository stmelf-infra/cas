...
/**
 * Action that handles the TicketGrantingTicket creation and destruction. If the action is given a TicketGrantingTicket
 * and one also already exists, the old one is destroyed and replaced with the new one. This action always returns
 * "success".
 *
