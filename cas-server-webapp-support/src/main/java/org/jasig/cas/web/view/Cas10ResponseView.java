...
/**
 * Custom View to Return the CAS 1.0 Protocol Response. Implemented as a view class rather than a JSP (like CAS 2.0
 * spec) because of the requirement of the line feeds to be "\n".
 *
