...
/**
 * Extension of {@link SchedulerFactoryBean} that collects trigger bean definitions from the application context and
 * calls {@link #setTriggers(org.quartz.Trigger[])} to autowire triggers at {@link #afterPropertiesSet()} time.
 *
...
public final class AutowiringSchedulerFactoryBean extends SchedulerFactoryBean implements ApplicationContextAware,
	...
	public void afterPropertiesSet() throws Exception {
		...
		logger.debug(
				"Autowired the following triggers defined in application context: {}",
