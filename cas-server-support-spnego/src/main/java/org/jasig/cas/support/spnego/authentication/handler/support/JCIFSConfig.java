...
public final class JCIFSConfig implements InitializingBean {
	...
	/**
	 * -- the service principal you just created. Using the previous example, this would be "HTTP/mybox at DOMAIN.COM".
	 */
	...
	/**
	 * @param jcifsDomainController
	 *            the jcifsDomainController to set
	 */
	...
	/**
	 * @param jcifsNetbiosWins
	 *            the jcifsNetbiosWins to set
	 */
